...
public final class MessageUtils {
    ...
    public static final String PREFIX = "&7[&fPluginHider&7] &6»&r ";
    ...
    public static void sendStartupMessage(JavaPlugin plugin) {
        String[] messages = {
                DIVIDER,
                PREFIX + plugin.getDescription().getName() + "&a Plugin Enabled!",
                PREFIX + "&d" + "Version: &b" + plugin.getDescription().getVersion(),
                PREFIX + "Developed by: &c" + plugin.getDescription().getAuthors(),
                DIVIDER
        };
    ...
    public static void mcQueenStartup(JavaPlugin plugin) {
        String[] messages = {
                PREFIX + "⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠿⠿⠿⠿⠿⣿⣿⣿⣿⣿⣿⣿⣿",
                PREFIX + "⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠋⣉⣁⣤⣤⣶⣾⣿⣿⣶⡄⢲⣯⢍⠁⠄⢀⢹⣿",
                PREFIX + "⣿⣿⣿⣿⣿⣿⣿⣿⣿⢯⣾⣿⣿⣏⣉⣹⠿⠇⠄⠽⠿⢷⡈⠿⠇⣀⣻⣿⡿⣻",
